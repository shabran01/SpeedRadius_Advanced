                    ...
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-body" style="font-size: larger;">
                            ...
                            <ul>
                                ...
                                <li>{Lang::T('Make sure your Mikrotik accessible from SpeedRadius')}</li>
                            </ul>
                        ...
                        <div class="box-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                ...
                                <a href="{$_url}community#update" style="color: black;" class="btn btn-success btn-sm btn-block">{Lang::T('Update SpeedRadius')}</a>
                            </div>
