        ...
        <div class="invoice-wrap">
            ...
            <div class="clearfix invoice-subhead mb20">
                <div class="group clearfix left">
                    ...
                    <p class="small">{if $router}{$router} - {/if}{$stype} [{date( $_c['date_format'], strtotime($fdate))} -
            ...
            <p class="text-center small text-info">{if $router}{$router} - {/if}{$stype} [{date( $_c['date_format'], strtotime($fdate))} -
                {date( $_c['date_format'], strtotime($tdate))}]</p>
        </div>
    </div>
</div>
