<?php
/* Smarty version 4.5.3, created on 2026-08-21 09:38:39
  from '/var/www/html/isp/ui/ui/hotspot_users.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_6a87f26ff35498_89972029',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c7d42df6756c1ddf701dd80ebd4f6cda51be73ce' => 
    array (
      0 => '/var/www/html/isp/ui/ui/hotspot_users.tpl',
      1 => 1787294213,
      2 => 'file',
    ),
  ),
...
function content_6a87f26ff35498_89972029 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
          ...
          <div>
            <select id="routerSelect" style="background: white; border: 1px solid #d1d5db; border-radius: 0.5rem; padding: 0.5rem 1rem; color: #374151; outline: none;">
              ...
              <?php if ((isset($_smarty_tpl->tpl_vars['routers']->value))) {?>
                <?php
...
hotspot/add" style="display: inline-flex; align-items: center; padding: 0.75rem 1.5rem; border: none; font-size: 1rem; font-weight: 500; border-radius: 0.5rem; color: white; background: #10b981; text-decoration: none; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
              <svg style="width: 1.25rem; height: 1.25rem; margin-right: 0.5rem;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo '<script'; ?>
>
  var _baseUrl = "<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
";
...
<?php echo '</script'; ?>
>
<style>@keyframes spin{to{transform:rotate(360deg)}}</style><?php }
}
