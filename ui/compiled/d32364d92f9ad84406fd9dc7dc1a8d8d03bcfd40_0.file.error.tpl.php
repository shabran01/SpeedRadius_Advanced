<?php
/* Smarty version 4.5.3, created on 2026-08-21 09:38:52
  from '/var/www/html/isp/ui/ui/error.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_6a87f27cf371c7_53413386',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd32364d92f9ad84406fd9dc7dc1a8d8d03bcfd40' => 
    array (
      0 => '/var/www/html/isp/ui/ui/error.tpl',
      1 => 1773500042,
      2 => 'file',
    ),
  ),
...
function content_6a87f27cf371c7_53413386 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body class="min-h-screen flex items-center justify-center p-6 bg-animated relative"
    ...
    <div class="w-full max-w-3xl rounded-3xl overflow-hidden animate-slide-up relative z-10"
        ...
        <div class="flex items-center gap-4 px-8 py-7"
            ...
            <div>
                <h1 class="text-2xl font-extrabold text-white tracking-tight"><?php echo $_smarty_tpl->tpl_vars['error_title']->value;?>
</h1>
        ...
        <div class="px-8 py-7 glass">
            ...
            <ul class="space-y-2 mb-6">
                <li class="flex items-start gap-3 text-sm" style="color:rgba(255,255,255,0.65);">
                    ...
                    <?php echo Lang::T('Make sure you use API Port, Default 8728');?>

                </li>
                <li class="flex items-start gap-3 text-sm" style="color:rgba(255,255,255,0.65);">
                    <span class="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold mt-0.5"
                          style="background:rgba(56,239,125,0.18);color:#38ef7d;">✓</span>
                    <?php echo Lang::T('Make sure Username and Password are correct');?>

                </li>
                <li class="flex items-start gap-3 text-sm" style="color:rgba(255,255,255,0.65);">
                    <span class="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold mt-0.5"
                          style="background:rgba(56,239,125,0.18);color:#38ef7d;">✓</span>
                    <?php echo Lang::T('Make sure your hosting not blocking port to external');?>

                </li>
                <li class="flex items-start gap-3 text-sm" style="color:rgba(255,255,255,0.65);">
                    <span class="flex-shrink-0 flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold mt-0.5"
                          style="background:rgba(56,239,125,0.18);color:#38ef7d;">✓</span>
                    <?php echo Lang::T('Make sure your Mikrotik accessible from SpeedRadius');?>
...
community#update"
                   ...
                   style="background:linear-gradient(135deg,#11998e,#38ef7d);box-shadow:0 6px 20px rgba(56,239,125,0.3);">
                    ⬆ <?php echo Lang::T('Update SpeedRadius');?>
        ...
        <div class="text-center text-xs px-8 py-4"
            ...
            SpeedRadius &nbsp;·&nbsp; <?php echo $_smarty_tpl->tpl_vars['error_title']->value;?>
