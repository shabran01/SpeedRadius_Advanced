...
.msg-avatar.ai { background: linear-gradient(135deg,#7c3aed,#a78bfa); color:#fff; }
...
.ai-chat-input-wrap textarea:focus { border-color: #7c3aed; }
.ai-send-btn {
...
.suggestion-chip:hover, .suggestion-chip:active { background: #7c3aed; color: #fff; border-color: #7c3aed; }
        ...
        <div class="row">
                ...
                <div class="ai-chat-wrap">
                    ...
                    <div class="ai-chat-header">
                        <div style="display:flex;align-items:center;gap:10px">
                            <div style="width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#7c3aed,#a78bfa);display:flex;align-items:center;justify-content:center;font-size:19px;color:#fff;flex-shrink:0">
                                <i class="ion ion-chatbubbles"></i>
                            </div>
                            <div>
                                <div class="ai-header-title" style="color:#fff;font-weight:600;font-size:15px">Mistral AI Assistant</div>
                                <div class="ai-header-sub" style="color:#a090c0;font-size:11px">Powered by Mistral AI &bull; ISP Support</div>
                            </div>
                        </div>
                        <div class="ai-header-controls" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
                            ...
                            <a href="{$_url}plugin/mistral_ai/config" class="btn btn-xs btn-default" title="Settings">
                                <i class="fa fa-cog"></i>
                            </a>
                        </div>
                    </div>
            ...
            <div class="ai-sidebar col-md-3 col-lg-2" style="padding-left:8px">
                <div class="panel panel-default" style="border-radius:10px;overflow:hidden">
                    <div class="panel-heading" style="background:linear-gradient(135deg,#1a1a2e,#2d1b69);color:#fff;border:none">
                        <b><i class="fa fa-info-circle"></i> About</b>
                    </div>
                    <div class="panel-body" style="font-size:13px;padding:14px">
                        <p style="color:#666">Mistral AI can assist with ISP operations and general questions.</p>
                        ...
                        <hr style="margin:10px 0">
                        <a href="{$_url}plugin/mistral_ai/config" class="btn btn-block btn-default btn-xs">
...
function sendMessage() {
    ...
    $.get(baseUrl + 'plugin/mistral_ai/token', function(data) {
        ...
        fetch(baseUrl + 'plugin/mistral_ai/api', { method: 'POST', body: formData })
