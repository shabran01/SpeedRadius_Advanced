  ...
  if ($userType == 'OneTimeUser') {
    ...
    if ($response_code == "0") {
      ...
      if ($rechargeResult === false) {
        ...
        error_log("Mpesa: Payment successful for user: " . $PaymentGatewayRecord->username . ", Amount: " . $amount_paid . ", Mpesa Code: " . $mpesa_code . ($isBalanceTopup ? " (Balance top-up)" : " (Package)"));
      }
    }
  } else {
